 ...
 * or in fields if .json
 * return [old path, new path] (array) in case of success
 *		  		  or filename (string) in case of failure 
 *************************************************************/
function appendFileInfo(file, data, extension, callback){
	if (extension === 'txt') {
		var buff = ''
		...
		return callback(null, 'Wrong Type')
}
